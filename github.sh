...
export name='Rafael Tabolka'
export email="rafaeltabolka@hotmail.com"
export repositorio="https://github.com/RafaelTabolka/Imobiliaria_html_css_puro.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="Data Criação " & (date -I)
...
git commit -am "Projeto feito em $(date)"
